...
namespace Sylar{
    ...
    class ConfigVarBase{
        ...
        virtual bool fromString(const std::string&val)=0;//由字符串初始化
...
/**
 * @brief 类型转换模板偏特化(std::vector<T>->YAML String)
 */
template<class T>
...
class ConfigVar:public ConfigVarBase{
    ...
    using on_change_cb=std::function<void(const T&old_value,const T&new_value)>;
        /**
         * @brief 通过参数名，参数值，描述构造CongfigVar
         * @param[in] name 参数名称有效字符[0-9,a-z,_]
